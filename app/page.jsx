...
const InteractiveGraph = lazy(() => import('../src/components/InteractiveGraph/InteractiveGraph'))
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <Suspense fallback={<div style={{ height: '600px', background: 'var(--color-background-secondary)' }} />}>
          <InteractiveGraph />
        </Suspense>
