...
const Footer = () => {
  return (
    <footer className="w-full bg-footer-bg pt-10 pb-8 px-20 max-md:py-8 max-md:px-5 border-t border-divider-light dark:border-divider-dark relative overflow-hidden font-sans text-footer-text box-border">
      <StarIcon />
      <BlobIcon />
      ...
      <div className="relative z-[2] mx-auto my-4 max-w-[1000px] bg-white/[0.08] border border-white/[0.15] rounded-2xl backdrop-blur-md shadow-[0_12px_40px_rgba(0,0,0,0.15)] px-10 py-6 box-border max-md:my-3 max-md:p-6">
        ...
        <div className="flex justify-between items-start mb-6 flex-wrap gap-8 max-md:flex-col max-md:gap-10">
          ...
          <div className="flex gap-12 flex-wrap max-md:flex-col max-md:gap-8">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://github.com/kritikamandale" target="_blank" rel="noopener noreferrer" className="text-footer-text text-sm font-medium opacity-85 leading-loose transition-all duration-250 hover:opacity-100 hover:text-brand-yellow uppercase underline underline-offset-4 p-3 -m-3 inline-block min-h-[44px] min-w-[44px]">GITHUB</a>
        ...
        <div className="relative my-6 max-md:my-4">
          ...
          <p className="relative z-[1] font-heading text-[clamp(48px,9vw,88px)] font-bold tracking-tight m-0 leading-tight text-footer-text">KRITIKALOG</p>
