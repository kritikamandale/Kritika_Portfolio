    ...
    >
      <div className="flex flex-col max-w-[800px] mx-auto">
        {PHILOSOPHIES.map((item, index) => (
          <div key={item.id} className={`flex items-start gap-4 md:gap-6 py-4 md:py-6 border-b-[0.5px] border-black/15 dark:border-white/15 first:pt-0 last:border-b-0 last:pb-0 reveal reveal-delay-${index + 1}`}>
